...
sns.lmplot(x = 'danceability',y = 'energy',data = players,
...
for i in players.cluster.unique():
    centers.append(players.loc[players.cluster == i,['danceability','energy','valence','tempo','loudness','mode','key','acousticness','instrumentalness','liveness','speechiness','duration_ms','popularity']].mean())
# 将列表转换为数组，便于后面的索引取数
centers = np.array(centers)

# 绘制散点图
sns.lmplot(x = 'danceability', y = 'energy', hue = 'cluster', data = players, markers = ['^','s','o'],
